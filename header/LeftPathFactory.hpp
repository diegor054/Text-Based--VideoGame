...
class LeftPathFactory : public AbstractStageFactory {
 public:
    ...
    virtual vector<BaseCharacter*> getStage5() override {return vector<BaseCharacter*>{player, new Goblins(), new Golbins(), new Golbins(), new Golbins(), new Golbins(), new Goblins()};} //double goblins
    virtual vector<BaseCharacter*> getStage6() override {return vector<BaseCharacter*>{player, new Goblins(), new Golbins(), new Golbins(), new Golbins(), new Golbins(), new Goblins()};} //upgraded goblins  
    ...
    virtual vector<BaseCharacter*> getStage9() override {return vector<BaseCharacter*>{player, new Fairies(), new Fairies(), new Fairies(), new Fairies(), new Faries(), new Fairies()};} // these will be very strong
